...
description: Baseline cross-project JavaScript coding standards for naming, readability, immutability, and code-quality.
...
Use the new.target check in constructors to ensure they are called with the new operator
```javascript
